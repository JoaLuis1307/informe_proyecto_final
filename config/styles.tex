...
\definecolor{InfoBG}{HTML}{F5F3FF}        % Fondo Indigo ultra-suave  dame paletas de colores premmium para informes top 
% -------------------------------------------------------------
% PDF
% -------------------------------------------------------------
...
{\normalsize\bfseries\color{MutedGray}}
{\thesubsubsection.}
{0.40em}
{}
...
% Puntos de guía (dot leaders) para capítulos, secciones y subsecciones
\renewcommand{\cftchapleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsecleader}{\normalfont\cftdotfill{\cftdotsep}}
\renewcommand{\cftsubsecleader}{\normalfont\cftdotfill{\cftdotsep}}

% Estilo de fuentes para Capítulo (negrita y color principal)
\renewcommand{\cftchapfont}{\bfseries\color{PrimaryDark}}
\renewcommand{\cftchappagefont}{\bfseries\color{PrimaryDark}}

% Estilo de fuentes para Sección y Subsección
...
% Convertir capítulos a mayúsculas automáticamente en el índice (TOC)
